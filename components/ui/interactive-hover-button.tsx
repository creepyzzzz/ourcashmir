...
>(({ children, className, ...props }, ref) => {
    return (
        <button
            ref={ref}
            className={cn(
                "group relative w-32 cursor-pointer overflow-hidden rounded-full border border-brand-primary/20 bg-brand-primary p-2 text-center font-semibold text-black",
                className,
            )}
            {...props}
        >
